...
/*-----------------------------------------------
  ...
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__csmo

#else
#  define SWIG_init    init_csmo

#endif
#define SWIG_name    "_csmo"
...
SWIGINTERN PyObject *_wrap_runSMO(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOO:runSMO",&obj0,&obj1,&obj2)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_DataSet, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "runSMO" "', argument " "1"" of type '" "DataSet *""'"); 
  }
  arg1 = reinterpret_cast< DataSet * >(argp1);
  {
    ...
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "runSMO" "', argument " "2"" of type '" "std::vector< double,std::allocator< double > > const &""'"); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "runSMO" "', argument " "2"" of type '" "std::vector< double,std::allocator< double > > const &""'"); 
    }
    arg2 = ptr;
  }
  ecode3 = SWIG_AsVal_int(obj2, &val3);
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), "in method '" "runSMO" "', argument " "3"" of type '" "int""'");
  } 
  arg3 = static_cast< int >(val3);
  result = runSMO(arg1,(std::vector< double,std::allocator< double > > const &)*arg2,arg3);
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"runSMO", _wrap_runSMO, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
